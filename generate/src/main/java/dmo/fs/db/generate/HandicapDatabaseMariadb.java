...
public class HandicapDatabaseMariadb extends DbMariadb {
    ...
    public HandicapDatabaseMariadb(Boolean isCreateTables) throws InterruptedException, IOException, SQLException {
        super();
        defaultNode = dodexUtil.getDefaultNode();
        webEnv = webEnv == null || "prod".equals(webEnv) ? "prod" : "dev";
                ...
                tx -> conn.query(CHECKUSERSQL).rxExecute().doOnSuccess(rows -> {
                    ...
                    if (val == null) {
                        ...
                        crow.subscribe(result -> {
                            //
                        }, err -> logger.info(String.format("Users Table Error: %s",
                                err.getMessage())));
                    }
                    ...
                    .flatMap(
                        result -> conn.query(CHECKHANDICAPSQL).rxExecute()
                            ...
                            .doOnSuccess(rows -> {
                                ...
                                conn.query(getCreateTable("GOLFER")).rxExecute()
                                    .doOnError(err -> {
                                    ...
                                    .doOnSuccess(row1 -> {
                                        ...
                                        conn.query(getCreateTable("COURSE")).rxExecute()
                                            .doOnError(err -> {
                                                ...
                                                conn.query(getCreateTable("RATINGS")).rxExecute()
                                                    .doOnError(err -> {
                                                        ...
                                                        conn.query(getCreateTable("SCORES")).rxExecute()
                                                            .doOnError(err -> {
