...
<body>
  ...
  <div class="dodex--open">
    <img src="../node_modules/dodex/images/dodex_g.ico" alt="dodex">
  </div>
  ...
  <script>
    ...
    dodex.setContentFile("../node_modules/dodex-mess/data/content.server.js");
    dodex.init({/*width:550, height:250, left: "25%", top: "150px"*/
      ...
      server: "localhost:3087" // configured websocket server - example in node_modules/dodex-mess, koa.js
    })
      .then(function () {
        for (var i = 0; i < 3; i++) {
