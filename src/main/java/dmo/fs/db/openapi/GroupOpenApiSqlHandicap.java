...
//@SessionScoped
@Dependent
public class GroupOpenApiSqlHandicap {
  protected final static Logger logger = LoggerFactory.getLogger(GroupOpenApiSqlHandicap.class.getName());
  ...
  public GroupOpenApiSqlHandicap() {
  }
