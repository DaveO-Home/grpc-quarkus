...
module.exports = (env, argv) => {
    ...
    return {
        ...
        output: {
            ...
            path: path.resolve(__dirname, "../../../main/resources/META-INF/resources/dist"),
        ...
        plugins: [
            ...
            new HtmlWebpackPlugin({
                filename: path.resolve("../../main/resources/META-INF/resources/handicap.html"),
            ...
            new CopyPlugin({
                patterns: [
                  { from: path.resolve("./static"), to: path.resolve("../../main/resources/META-INF/resources/handicap/") },
                ],
              }),
        ],
